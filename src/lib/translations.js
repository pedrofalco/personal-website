export default {
    en: {
        ...
        viewer_0:"baked-model-viewer allows you to explore 3D models with baked textures in GLB format. You can upload your own GLB files containing color, emissive and/or alpha textures, and visualize them in a 3D environment with point-locker-controls.",
    ...
    es: {
        ...
        viewer_0:"baked-model-viewer permite explorar modelos 3D con texturas bakeadas en formato GLB. Podes subir tus propios archivos GLB que contengan texturas de color, emisivas y/o alfa, y visualizarlas en un entorno 3D web con point-locker-controls.",
